"use strict";
let guests = [`D`, `B`, `C`]; //This is called an array. It saves more data in one variable.
...
guests.unshift(`G`); //(array).unshift() is used to add a new name at first(0) index in an array at first index(0).
guests.splice(2, 0, `E`); //Array.splice(2, 0, `added name`) is used to add new name in an array at second index (1)
...
guests.push(`F`); // array.push() is used to place a name at the end of array name.
//for (let i = 0; i < guests.length; i++) {
//console.log(`Mr. ` + guests[i] + `,`, `\n\n It is our pleasure that you\'ve been invited. \n\nThanks!\n\n`);
// }
// ;
