...
let current_Users:string[] = [`JuNed`,`BilAl`,`SijAwal`, `ZAheer`,`lAtif`];
let new_Users:string[] = [`Kamran`,`Usman`,`BilAl`,`Zulfiqar`,`ZAheer`];

new_Users.forEach(freshUser => {
let lowerCase:string = freshUser.toLowerCase();
